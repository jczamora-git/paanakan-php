        ...
        <ul class="nav-list primary-nav">
            ...
            <li class="nav-item dropdown-container">
                ...
                <ul class="dropdown-menu">
                    <li class="nav-item">
                        <a href="online_appointments.php" class="nav-link <?= ($current_page == 'online_appointments.php') ? 'active' : '' ?>">Online Appointments</a>
                    </li>
                    <li class="nav-item">
                        <a href="manage_appointments.php" class="nav-link <?= ($current_page == 'manage_appointments.php') ? 'active' : '' ?>">Manage Appointments</a>
                    </li>
                    <li class="nav-item">
                        <a href="appointment_records.php" class="nav-link <?= ($current_page == 'appointment_records.php') ? 'active' : '' ?>">Appointment Records</a>
                    </li>
                </ul>
            </li>

            <li class="nav-item">
                <a href="manage_health_records.php" class="nav-link <?= ($current_page == 'manage_health_records.php') ? 'active' : '' ?>">
            ...
            <li class="nav-item">
                <a href="patient.php" class="nav-link <?= ($current_page == 'patient.php') ? 'active' : '' ?>">
            ...
            <li class="nav-item">
                <a href="supply.php" class="nav-link <?= ($current_page == 'supply.php') ? 'active' : '' ?>">
            ...
            <li class="nav-item">
                <a href="billing.php" class="nav-link <?= ($current_page == 'billing.php') ? 'active' : '' ?>">
